...
intersectBed -a ${i}_sorted.txt -b /home/jbarbour/final_ERCC2_paper/annotations/bladder_mapped_bin_1.bed -sorted -c | awk ' { SUM += $8 } END {print SUM}' - > bin_1_${i} ;
intersectBed -a ${i}_sorted.txt -b /home/jbarbour/final_ERCC2_paper/annotations/bladder_mapped_bin_2.bed -sorted -c | awk ' { SUM += $8 } END {print SUM}' - > bin_2_${i} ;
intersectBed -a ${i}_sorted.txt -b /home/jbarbour/final_ERCC2_paper/annotations/bladder_mapped_bin_3.bed -sorted -c | awk ' { SUM += $8 } END {print SUM}' - > bin_3_${i} ;
intersectBed -a ${i}_sorted.txt -b /home/jbarbour/final_ERCC2_paper/annotations/bladder_mapped_bin_4.bed -sorted -c | awk ' { SUM += $8 } END {print SUM}' - > bin_4_${i} ;
intersectBed -a ${i}_sorted.txt -b /home/jbarbour/final_ERCC2_paper/annotations/bladder_mapped_bin_5.bed -sorted -c | awk ' { SUM += $8 } END {print SUM}' - > bin_5_${i} ;
...
intersectBed -a ${i}_sorted.txt -b /home/jbarbour/final_ERCC2_paper/annotations/bladder_mapped_bin_1.bed -sorted -c | awk ' { SUM += $8 } END {print (SUM/100)}' - > bin_1_${i} ;
intersectBed -a ${i}_sorted.txt -b /home/jbarbour/final_ERCC2_paper/annotations/bladder_mapped_bin_2.bed -sorted -c | awk ' { SUM += $8 } END {print (SUM/100)}' - > bin_2_${i} ;
intersectBed -a ${i}_sorted.txt -b /home/jbarbour/final_ERCC2_paper/annotations/bladder_mapped_bin_3.bed -sorted -c | awk ' { SUM += $8 } END {print (SUM/100)}' - > bin_3_${i} ;
intersectBed -a ${i}_sorted.txt -b /home/jbarbour/final_ERCC2_paper/annotations/bladder_mapped_bin_4.bed -sorted -c | awk ' { SUM += $8 } END {print (SUM/100)}' - > bin_4_${i} ;
intersectBed -a ${i}_sorted.txt -b /home/jbarbour/final_ERCC2_paper/annotations/bladder_mapped_bin_5.bed -sorted -c | awk ' { SUM += $8 } END {print (SUM/100)}' - > bin_5_${i} ;
...
rename s/DHS_landscape/DHS_landscape_APOBEC/ DHS_landscape.txt
